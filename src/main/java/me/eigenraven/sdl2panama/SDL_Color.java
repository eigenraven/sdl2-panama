...
public class SDL_Color {
    ...
    public static byte r$get(MemorySegment seg) {
        return (byte)constants$42.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte r$get(MemorySegment seg, long index) {
        return (byte)constants$42.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte g$get(MemorySegment seg) {
        return (byte)constants$42.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte g$get(MemorySegment seg, long index) {
        return (byte)constants$42.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte b$get(MemorySegment seg) {
        return (byte)constants$42.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte b$get(MemorySegment seg, long index) {
        return (byte)constants$42.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte a$get(MemorySegment seg) {
        return (byte)constants$42.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte a$get(MemorySegment seg, long index) {
        return (byte)constants$42.const$4.get(seg.asSlice(index*sizeof()));
    }
