...
public class SDL_JoyBallEvent {
    ...
    public static short xrel$get(MemorySegment seg) {
        return (short)constants$141.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short xrel$get(MemorySegment seg, long index) {
        return (short)constants$141.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short yrel$get(MemorySegment seg) {
        return (short)constants$141.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short yrel$get(MemorySegment seg, long index) {
        return (short)constants$141.const$4.get(seg.asSlice(index*sizeof()));
    }
