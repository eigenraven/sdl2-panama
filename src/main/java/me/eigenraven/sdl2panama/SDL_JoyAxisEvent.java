...
public class SDL_JoyAxisEvent {
    ...
    public static byte axis$get(MemorySegment seg) {
        return (byte)constants$139.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte axis$get(MemorySegment seg, long index) {
        return (byte)constants$139.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding1$get(MemorySegment seg) {
        return (byte)constants$139.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding1$get(MemorySegment seg, long index) {
        return (byte)constants$139.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short value$get(MemorySegment seg) {
        return (short)constants$139.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short value$get(MemorySegment seg, long index) {
        return (short)constants$139.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short padding4$get(MemorySegment seg) {
        return (short)constants$140.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short padding4$get(MemorySegment seg, long index) {
        return (short)constants$140.const$0.get(seg.asSlice(index*sizeof()));
    }
